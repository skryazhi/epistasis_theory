%%% Last update: 22 Jan 2020 (SK)
%%% This code calculates the epistasis coefficient for the simple 5-node
...
if IFCALCULATE
    ...
    for iz = 1:nz
        ...
        [uvec(iz), epsuvec(iz)] = get_u( VmMat([1 5 3 4], [1 5 3 4]) , KeqMat([1 5 3 4], [1 5 3 4]) );
